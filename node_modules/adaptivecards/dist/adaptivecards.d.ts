...
declare module 'adaptivecards/card-elements' {
	...
	export function createActionInstance(parent: CardElement, json: any, errors: Array<HostConfig.IValidationError>): Action;
	export function createElementInstance(parent: CardElement, json: any, errors: Array<HostConfig.IValidationError>): CardElement;
...
declare module 'adaptivecards/adaptivecards' {
	...
	export { SizeAndUnit, getEnumValueOrDefault } from 'adaptivecards/utils';
